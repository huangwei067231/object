...
},{}],"src/javascript/swrapper.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/javascript/main.js":[function(require,module,exports) {
"use strict";

require("./icons.js");

var _swrapper = _interopRequireDefault(require("./swrapper.js"));
...
function () {
  ...
  _createClass(Player, [{
    ...
    value: function start() {
      ...
      fetch('https://huangwei067231.github.io/data-mock/music-list.json').then(function (res) {
        return res.json();
      }).then(function (data) {
    ...
    value: function bind() {
      ...
      var swiper = new _swrapper.default(this.$('.panels'));
      swiper.on('swipLeft', function () {
        this.classList.remove('panel1');
        this.classList.add('panel2'); // this.$('.active').classList.remove('active').nextSibling.add('active') 
      });
    ...
    value: function setLyricToCenter(node) {
      ...
      this.$('.panel-lyrics .contain').style.transform = "translateY(-".concat(translateY, "px)");
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/javascript/main.js"], null)
//# sourceMappingURL=/main.be350885.js.map